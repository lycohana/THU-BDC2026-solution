...
config = {
    ...
    'selector': {
        'enabled': True,
        'version': 'exp-008_tri_state_gated_union_selector',
        'force_branch': None,
        ...
        'regime_branch_order': {
            'risk_on_strict': ['independent_union_rerank', 'legal_plus_1alpha', 'defensive_v2_strict', 'legal_minrisk_hardened'],
            'neutral_positive': ['independent_union_rerank', 'legal_plus_1alpha', 'legal_minrisk_hardened', 'defensive_v2_strict'],
            'mixed_defensive': ['independent_union_rerank', 'legal_plus_1alpha', 'legal_minrisk_hardened', 'defensive_v2_strict'],
            'risk_off': ['independent_union_rerank', 'legal_plus_1alpha', 'legal_minrisk_hardened', 'defensive_v2_strict'],
        },
        'gated_union_rerank': {
            'enabled': True,
